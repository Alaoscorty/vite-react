      ...
      <div>
        ...
        <nav className="sidebar-nav scroll-sidebar" data-simplebar="">
          <ul id="sidebarnav">
            ...
            <li className="sidebar-item">
              <Link className="sidebar-link" to="/recapCommande" aria-expanded="false">
                <span>
            ...
            <li className="sidebar-item">
              <Link className="sidebar-link" to="/Reservations" aria-expanded="false">
                <span>
            ...
            <li className="sidebar-item">
              <Link className="sidebar-link justify-content-between" to="/Crypto">
            ...
            <li className="sidebar-item">
              <Link className="sidebar-link justify-content-between" to="/propos">
                <div className="d-flex align-items-center gap-3">
                  <span className="d-flex">
                    <span className="icon-">
            ...
            <li className="sidebar-item">
              <Link className="sidebar-link" to="/parrainer" aria-expanded="false">
                <span>
