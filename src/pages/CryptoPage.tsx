...
function CryptoPage() {
  ...
  // Récupérer les produits du panier à partir du localStorage
  useEffect(() => {
  ...
  return (
    <Layout>
      <section style={{ display: "flex", justifyContent: "space-between" }}>
        ...
        {/* Section Paiement par Mobile Money */}
        <div className="container mt-5">
          ...
          {panier.length === 0 ? (
            ...
            <>
              <div className="text-center mb-4">
                <h4>Total à payer : <strong>{total} FCFA</strong></h4>
                <p className="text-muted">
                  Capture d'écran à envoyer sur{" "}
                  <Link to="https://wa.me/+22951563219" className="btn btn-secondary">
                    whatsapp
                  </Link>
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <button
                  className="btn btn-primary mt-3"
                  onClick={() => alert("Paiement confirmé ! Envoyez une capture en cliquant le bouton WhatsApp")}
                >
                  J’ai payé
                </button>
              </div>
