        ...
        <Layout>
            <section id="shop" className="container py-5">
                ...
                <div className="row">
                    ...
                    <div className="col-md-4">
                        <div className="card product-card">
                            <img src="images/femme.jpg" className="card-img-top" alt="Voile pour femme"/>
                    ...
                    <div className="col-md-4">
                        <div className="card product-card">
                            <img src="images/hijab1.jpg" className="card-img-top" alt="Hidjab"/>
                            <div className="card-body text-center">
                    ...
                    <div className="col-md-4">
                        <div className="card product-card">
                            <img src="images/femme2.jpg" className="card-img-top" alt="Tissus de soie"/>
                            <div className="card-body text-center">
                                <h5 className="card-title">Tissus de soie</h5>
                ...
                <div className="row">
                    ...
                    <div className="col-md-4">
                        <div className="card product-card">
                            <img src="images/tracer.jpg" className="card-img-top" alt="Tracer de sous cils"/>
                            <div className="card-body text-center">
                    ...
                    <div className="col-md-4">
                        <div className="card product-card">
                            <img src="images/manucure.jpg" className="card-img-top" alt="Manucure"/>
                            <div className="card-body text-center">
                    ...
                    <div className="col-md-4">
                        <div className="card product-card">
                            <img src="images/pedicure.jpg" className="card-img-top" alt="Pédicure"/>
                            <div className="card-body text-center">
                ...
                <div className="row">
                    ...
                    <div className="col-md-4">
                        <div className="card product-card">
                            <img src="images/bijoux.jpg" className="card-img-top" alt="Bijoux"/>
                            <div className="card-body text-center">
                    ...
                    <div className="col-md-4">
                        <div className="card product-card">
                            <img src="images/cosmétique.jpg" className="card-img-top" alt="Produits cosmétiques"/>
                            <div className="card-body text-center">
                    ...
                    <div className="col-md-4">
                        <div className="card product-card">
                            <img src="images/packk.jpg" className="card-img-top" alt="Chapeaux et accessoires"/>
                            <div className="card-body text-center">
